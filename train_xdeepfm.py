...
def fetch_data_name(data, dense_features, sparse_features):
...
if __name__ == "__main__":
    ...
    train_model_input, linear_feature_columns, dnn_feature_columns = fetch_data_name(data_train, dense_features, sparse_features)
    test_model_input, _, _ = fetch_data_name(data_test, dense_features, sparse_features)
    ...
    history = model.fit(train_model_input, data_train[target].values, batch_size=32, epochs=10, verbose=2,
